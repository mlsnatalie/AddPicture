...
public class LifecycleViewDelegatePresenter<V extends IView> extends ViewDelegatePresenter<V> implements LifecycleObserver {

    private Lifecycle lifecycle = null;
    private boolean isDestroy = false;

    public LifecycleViewDelegatePresenter(V view) {
        super(view);
    }
